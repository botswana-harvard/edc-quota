...
class TestOverride(TestCase):
    ...
    def test_combination(self):
        ...
        code, confirmation_code = override.create_confirmation_code()
    ...
    def test_combination_code_returns_code(self):
        override = Override()
        code1 = override.code
        code2, _ = override.create_confirmation_code(code1)
        self.assertEqual(code1, code2)

    def test_combination_manually(self):
        override = Override()
        code1 = override.code
        _, confirmation_code = override.create_confirmation_code(code1)
    ...
    def test_combination_blank(self):
        ...
        override.code = ''
        code, confirmation_code = override.create_confirmation_code('')
        self.assertFalse(override.validate_combination(code, confirmation_code))
